 <nav class="navbar navbar-default navbar-fixed-top be-top-header">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav navbar-right be-user-nav">
                <li class="dropdown">
                    <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="dropdown-toggle">
                        <?= $this->Html->image('avatar.png', ['alt' => 'Avatar']); ?>
                        <span class="user-name">Túpac Amaru</span>
                    </a>
                    <ul role="menu" class="dropdown-menu">
                        <li>
                            <div class="user-info">
                                <div class="user-name">Amit Shokeen</div>
          ...
          </div><a href="#" data-toggle="collapse" data-target="#be-navbar-collapse" class="be-toggle-top-header-menu collapsed">Menus</a>
          <div id="be-navbar-collapse" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
              <li><a href="/"><i class="icon mdi mdi-home"></i> Dashboard</a></li>
              <li><a href="stats"><i class="icon mdi mdi-chart-donut"></i> Stats</a></li>
              <li><a href="affiliates"><i class="icon mdi mdi-assignment"></i> Affiliates</a></li>
              <li><a href="advertisers"><i class="icon mdi mdi-assignment-check"></i> Advertisers</a></li>
              <li><a href="reports"><i class="icon mdi mdi-assignment-o"></i> Reports</a></li>
              <li><a href="setup"><i class="icon mdi mdi-settings"></i> Setup</a></li>
              <li><a href="activities"><i class="icon mdi mdi-hourglass-alt"></i> Activities</a></li>
              <li><a href="testing"><i class="icon mdi mdi-labels"></i> Testing</a></li>
            </ul>
          </div>
        </div>
      </nav>
